      ...
      <div className="container mx-auto px-4 py-16">
        <div className="text-center mb-16">
          <div className='flex justify-center items-center mb-6 gap-6'>
            ...
            <Image src="/bonusifygreen.png" width={190} height={20} alt="Bonusify Logo" />
          </div>
          <p className="text-dm xl:text-xl text-gray-600 max-w-3xl mx-auto">
        ...
        <div className="max-w-4xl mx-auto">
          ...
          {/* Founder Section */}
          <div className="bg-gray-50 rounded-lg shadow-md p-8 mb-8">
            <h2 className="text-3xl font-semibold text-gray-800 mb-6">Meet the Founder</h2>
            <div className="flex flex-col md:flex-row items-start gap-3">
              ...
              <div className="flex-1">
                <div className="flex items-center gap-2 mb-3">
                  <h3 className="text-2xl font-semibold text-blue-600">Monodeep Biswas</h3>
                  <div className="flex">
          ...
          <div className="bg-gray-500 rounded-lg shadow-md md:p-16 p-6 text-black text-center">
            <h2 className="text-2xl md:text-3xl font-semibold text-white mb-4">The Journey Continues</h2>
            <p className="text-sm md:text-md font-light text-gray-100 mb-6 max-w-4xl mx-auto">
            ...
            <div className="grid md:grid-cols-3 gap-4 mb-6 text-center">
              ...
              <div className="bg-white bg-opacity-20 rounded-lg p-4">
                <h3 className="text-xl font-bold mb-1">Growing Network</h3>
                <p>Partner Retailers</p>
              </div>
              <div className="bg-white bg-opacity-20 rounded-lg p-4">
                <h3 className="text-xl font-bold mb-1">Endless Potential</h3>
                <p>Future Opportunities</p>
              </div>
            </div>
            <p className="text-sm text-gray-100 opacity-90">
              Stay tuned for updates on our launch and be among the first to experience 
              the future of rewarding online shopping.
            </p>
          </div>
        </div>
      </div>
