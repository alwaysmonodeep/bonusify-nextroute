...
const WalletDashboard = () => {
  return (
        ...
        <div className="bg-gray-100 rounded-2xl shadow-lg border border-gray-200 px-4 py-8 mb-8 relative z-0 overflow-hidden">
          ...
          <div className="flex justify-between items-center relative z-10">
            ...
            <div className="flex flex-col pt-10 gap-3">
              <Link href={'/withdrawl'}><button className="bg-[#332B4E] cursor-pointer text-xs md:text-sm text-white px-4 md:px-6 py-3 rounded-xl font-semibold">
                Withdraw Now
              </button></Link>
    ...
    <div className="bg-gray-100 p-1 md:p-4 rounded-lg relative overflow-hidden shadow-sm">
          ...
          <div className="grid grid-cols-2 md:grid-cols-2 lg:grid-cols-4 gap-2 md:gap-6 space-y-4 md:space-y-2 px-2 py-4">
            ...
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <p className="text-xl md:text-2xl font-semibold text-black">₹111</p>
              </div>
            </div>
            ...
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <p className="text-xl md:text-2xl font-semibold text-gray-500">₹0</p>
              </div>
            </div>
            ...
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <p className="text-xl md:text-2xl font-semibold text-black">₹10</p>
              </div>
            </div>
        ...
        <div className="flex justify-center gap-4 mb-8">
          <Link href={"/wallet-history"}>
            <button className="bg-[#332B4E] text-xs md:text-base text-white cursor-pointer px-5 py-3 rounded-xl font-semibold transition-all duration-300 flex items-center gap-3 shadow-lg">
